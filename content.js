/**
 * Content Script - Injected into Gemini page (MAIN world)
 * Intercepts fetch requests to process downloaded images
 * 
 * This is a bundled script with all dependencies inlined
 */
...
(function () {
    ...
    class WatermarkEngine {
        ...
        async loadBackgroundImages() {
            // Background images embedded as base64 data URLs
